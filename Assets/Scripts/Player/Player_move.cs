...
public class Player_move : MonoBehaviour
{
    ...
    private void StartDownAttack()
    {
        ...
        // °⁄√ﬂ∞°: æ÷¥œ∏ﬁ¿Ã≈Õø° 'isDownAttacking' ∆ƒ∂ÛπÃ≈Õ ∞™¿ª true∑Œ º≥¡§«œ∂Û¥¬ Ω≈»£∏¶ ∫∏≥ø
    ...
    public void EndDownAttackAndBounce(BounceType bounceType)
    {
        ...
        // °⁄√ﬂ∞°: æ÷¥œ∏ﬁ¿Ã≈Õø° 'isDownAttacking' ∆ƒ∂ÛπÃ≈Õ ∞™¿ª false∑Œ º≥¡§«œ∂Û¥¬ Ω≈»£∏¶ ∫∏≥ø
    ...
    private void UpdateVisuals()
    {
        ...
        // °⁄ºˆ¡§: isJumping æ÷¥œ∏ﬁ¿Ãº«¿∫ isDownAttacking ªÛ≈¬∞° æ∆¥“ ∂ß∏∏ ¿Áª˝µ«µµ∑œ «‘
